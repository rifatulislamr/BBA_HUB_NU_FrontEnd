        ...
        <>
            <div className="rounded-3xl navbar fixed z-10 bg-opacity-50 max-w-screen-2xl bg-black text-white">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <label className={`btn btn-circle swap swap-rotate lg:hidden`}>
                            ...
                            <div className="hamburger-icon">
                                {
                                    isMobileNavOpen ? <svg className="swap-off fill-current" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 512 512"><polygon points="400 145.49 366.51 112 256 222.51 145.49 112 112 145.49 222.51 256 112 366.51 145.49 400 256 289.49 366.51 400 400 366.51 289.49 256 400 145.49" /></svg> : <svg className="swap-off fill-current" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 512 512"><path d="M64,384H448V341.33H64Zm0-106.67H448V234.67H64ZM64,128v42.67H448V128Z" /></svg>
                                }
                    ...
                    <Link to="/" className="btn btn-ghost normal-case text-3xl">
                        <span className="text-rose-700"><span className="text-zinc-50">T</span><span className="text-amber-400">H</span>E BBA </span><span className="text-amber-400">H<span className="text-zinc-50">U</span>B</span>
                    </Link>
                </div>
                <div className="navbar-center hidden lg:flex">
                    <ul className="menu menu-horizontal px-1">
...
//                 <div className="navbar-start">
//                     <div className="dropdown">
//                         <label className={`btn btn-circle swap swap-rotate lg:hidden`} onClick={handleMobileNavToggle}>
//                             <input type="checkbox" checked={isMobileNavOpen} onChange={() => { }} />
//                             {isMobileNavOpen ? (
